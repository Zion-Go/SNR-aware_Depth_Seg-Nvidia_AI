...
class Unimatch_depth(Node):
    def __init__(self):
        ...
        self.left_sub = message_filters.Subscriber(self, Image, "/left/image_resize", qos_profile=qos_policy)
        self.right_sub = message_filters.Subscriber(self, Image, "/right/image_resize", qos_profile=qos_policy)
