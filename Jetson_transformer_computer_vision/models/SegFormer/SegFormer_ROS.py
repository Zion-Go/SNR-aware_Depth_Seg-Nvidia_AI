...
class SegFormer(Node):
    def __init__(self):
        ...
        self.seg_sub = self.create_subscription(Image, 'right/image_resize', self.raw_sub_callback, qos_profile=qos_policy)
        self.seg_publish = self.create_publisher(Image, 'right/image_seg', 20)
    ...
    def seg_pub_callback(self):
        ...
        for n in range(len(image_list) + 1):
            ...
            with torch.no_grad():
                ...
                seg_msg.header.frame_id = "right_camera"
