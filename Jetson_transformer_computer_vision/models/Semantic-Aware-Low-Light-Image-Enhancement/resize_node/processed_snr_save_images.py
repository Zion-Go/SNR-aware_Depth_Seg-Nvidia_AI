...
class SNR_Save_Sub(Node):
    def __init__(self):
        super().__init__("SNR_Save_Sub")
        ...
        self.resize_sub = self.create_subscription(Image, 'left/image_snr', self.resize_sub_callback, qos_profile=qos_policy)
...
def main(args=None):
    ...
    SNR_save_sub = SNR_Save_Sub()
    rclpy.spin(SNR_save_sub)
    SNR_save_sub.destroy_node()
    rclpy.shutdown()
