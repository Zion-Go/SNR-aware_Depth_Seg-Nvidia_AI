...
jpg_list = sorted(glob.glob(os.path.join(test_path, '*.png')))
...
for image in jpg_list:
    ...
    with torch.no_grad():
        ...
        with torch.no_grad():
            ...
            # if key == ord("s"):
            dpt_path = f"/workspaces/isaac_ros-dev/src/Semantic-Aware-Low-Light-Image-Enhancement/experiments_dataset/tables_figures/nighttime_driving/dpt_nighttime_snr_{count}.jpg"
