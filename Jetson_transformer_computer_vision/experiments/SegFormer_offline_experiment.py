...
test_path = '/workspaces/isaac_ros-dev/src/Semantic-Aware-Low-Light-Image-Enhancement/experiments_dataset/tables_figures/nighttime_driving/snr_dataset'
output_path = '/workspaces/isaac_ros-dev/src/Semantic-Aware-Low-Light-Image-Enhancement/experiments_dataset/tables_figures/nighttime_driving/'

count = 0
jpg_list = sorted(glob.glob(osp.join(test_path, '*.png')))
...
for image in jpg_list:
    ...
    with torch.no_grad():
        ...
        # Save the outputs
        cv2.imwrite(f'{output_path}/nighttime_segsnr_{count}.jpg', img_seg)
